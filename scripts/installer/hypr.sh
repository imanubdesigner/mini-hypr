...
run_command "mkdir -p /home/$SUDO_USER/.config/ && cp -r $BASE_DIR/configs/uwsm /home/$SUDO_USER/.config/ && chown -R $SUDO_USER:$SUDO_USER /home/$SUDO_USER/.config/uwsm" "Copy entire uwsm config folder (Must)" "yes" "no"
